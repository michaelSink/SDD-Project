          ...
          child: Column(
            children: [
              ...
              TextFormField(
                ...
                initialValue: "${diagnosis.diagnosedOn.year.toString()}-${diagnosis.diagnosedOn.month.toString().padLeft(2, '0')}-${diagnosis.diagnosedOn.day.toString().padLeft(2,'0')}",
                autocorrect: false,
              ...
              TextFormField(
                ...
                initialValue: diagnosis.treatments.toString().replaceFirst("[", "").replaceAll("]", ""),
                autocorrect: false,
...
class _Controller{
  ...
  void onSavedTreatments(String value){
    _state.diagnosis.treatments = value.split(',').map((e) => e.trim()).toList();
  }
